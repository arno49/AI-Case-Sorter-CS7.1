...
- The firmware is a cooperative state machine. `loop()` services serial input, proximity sensing, sorter movement/completion, feed scheduling/errors/movement/homing, nonblocking feed/AirDrop completion, diagnostics, and motor standby. Feed movement is blocked while sorting is active; both axes home through sensor-driven states and optional offsets.
